...
class ResNet(object):
    ...
    def _residual(self, x, in_filter, out_filter, stride, activate_before_residual=False):
        if activate_before_residual:
            with tf.variable_scope('shared_activation'):
                ...
                x = self._relu(x, self.hp.relu_leakiness)
                orig_x = x
        else:
    ...
    def _conv(self, name, filter_size, in_filters, out_filters, strides):
        '''conv2d with MSRA init'''
        ...
        with tf.variable_scope(name):
            ...
            return tf.nn.conv2d(x, kernel, strdes, padding='SAME')
